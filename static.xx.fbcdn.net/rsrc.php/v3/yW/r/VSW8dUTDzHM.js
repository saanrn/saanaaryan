...
__d("FalcoLoggerInternal", ["AnalyticsCoreData", "BaseEventEmitter", "FBLogger", "PersistedQueue", "Random", "ServerTime", "isPromise", "performanceAbsoluteNow", "regeneratorRuntime"], (function(a, b, c, d, e, f, g) {
    ...
    function m(a, e, f, g, i) {
        var j, k, m, n, o, p, q, r, s;
        return b("regeneratorRuntime").async(function(t) {
            while (1) switch (t.prev = t.next) {
                ...
                case 21:
                    ...
                    c("FBLogger")("falco", "oversized_message:" + a).warn('Dropping event "%s" due to exceeding the max size %s at %s', a, h, q.length);
                ...
                case 26:
                    c("AnalyticsCoreData").enable_observer && (r = function() {
                        var a;
                        return (a = m) != null ? a : g()
                    }, s = {
                        name: a,
                        ...
                        getData: r,
                        policy: e
                    }, f && (s.getPrivacyContext = function() {
                        var a;
                        return (a = n) != null ? a : f()
                    }), l.emit("event", s));
                case 27:
