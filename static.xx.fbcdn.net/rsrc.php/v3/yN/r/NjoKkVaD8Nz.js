...
__d("FalcoLoggerTransports", ["AnalyticsCoreData", "Banzai", "JSResource", "ODS", "PersistedQueue", "Queue", "WebSession", "performanceAbsoluteNow", "promiseDone", "uuid"], (function(a, b, c, d, e, f, g) {
    ...
    function C(a, b) {
        D("planes.banzai.write", a.length);
    ...
    var E = {
        log: function(a, b) {
            C(a, c("Banzai").BASIC), b(!0)
        },
        logImmediately: function(a, b) {
            C(a, c("Banzai").VITAL), b(!0)
        },
    ...
    function F(a) {
        var b = G(a, "banzai_data_loss"),
            d = G(a, "bladerunner_data_loss");
        l.enqueue(function(a) {
            return a.log([d], function(a) {})
        });
        C([b], c("Banzai").BASIC)
    }
    ...
    function J() {
        ...
        c("JSResource").loadAll([c("JSResource")("TransportSelectingClientSingleton").__setRef("FalcoLoggerTransports"), c("JSResource")("RequestStreamCommonRequestStreamCommonTypes").__setRef("FalcoLoggerTransports")], function(a, b) {
            ...
            b = {
                onTermination: function(a) {
                    a.message === "Stream closed" ? (l.stop(!0), t = !1) : (v = !1, l.start(function(a) {
                        return a(E)
                    }))
                },
            ...
            c("promiseDone")(a.requestStream({
                method: "Falco"
            }, JSON.stringify(B(d("WebSession").getId())), b, {
                requestId: ""
            }).then(function(a) {
                f = a
            })["catch"](function(a) {
        ...
        c("AnalyticsCoreData").enable_dataloss_timer && (H(), I());
        t = !0
    }

    function K(a) {
        return c("AnalyticsCoreData").enable_bladerunner && v && a.s === 1
    }
    ...
    function a() {
        ...
        c("PersistedQueue").setHandler("falco_queue_log", function(a) {
            ...
            while (b = a.dequeueItem())(function(b) {
                K(b.item.policy) ? (J(), r == null && (r = setTimeout(z, i)), y(a, b)) : E.log([b.item], function(c) {
        ...
        c("PersistedQueue").setHandler("falco_queue_immediately", function(a) {
            var b;
            while (b = a.dequeueItem())(function(b) {
                K(b.item.policy) ? (J(), (r == null || !s) && (clearTimeout(r), r = setTimeout(z, j), s = !0), y(a, b)) : E.logImmediately([b.item], function(c) {
                    return a.markItem(b, c)
                })
            })(b)
        });
        c("PersistedQueue").setHandler("falco_queue_critical", function(a) {
            ...
            while (b = a.dequeueItem())(function(b) {
                var c = b.item;
                K(c.policy) ? (J(), l.enqueue(function(d) {
                    return d.logCritical([c], function(c) {
                        return a.markItem(b, c)
                    })
                })) : E.logCritical([c], function(c) {
                    return a.markItem(b, c)
                })
            })(b)
        })
