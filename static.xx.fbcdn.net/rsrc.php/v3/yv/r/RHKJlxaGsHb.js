...
__d("FbtErrorListenerWWW", ["FBLogger", "killswitch"], (function(a, b, c, d, e, f, g) {
    a = function() {
        ...
        b.onDuplicateSubstitutionTokenError_EXPERIMENTAL = function(a) {
            a = c("killswitch")("JS_RELIABILITY_FBT_LOGGING") ? "Duplicate token name not logged" : a;
            c("FBLogger")("i18n.error", "onDuplicateSubstitutionTokenError").blameToPreviousDirectory().blameToPreviousDirectory().mustfix("Cannot register a substitution with token=`%s` more than once", a)
        };
        ...
        a.forEach(function(a) {
            ...
            for (var d in a)
                if (l.call(a, d)) {
                    if (c[d] != null) {
                        var e;
                        (e = (h || (h = b("FbtHooks"))).getErrorListener({
                            translation: "<<unresolved translation>>",
                            hash: null
                        })) == null ? void 0 : e.onDuplicateSubstitutionTokenError_EXPERIMENTAL == null ? void 0 : e.onDuplicateSubstitutionTokenError_EXPERIMENTAL(d)
                    }
                    c[d] = a[d]
                }
        });
